...
export const Daily = () => {
  ...
  useEffect(() => {
    ...
    initializeFeats(setFeats, setLoadedFeat, rand.next())
  }, [])
  ...
  return (
    <div className="App">
      ...
      <p style={basicTextStyle}>The daily, which changes everyday based on the UTC+7 timesone.<br></br>Guess the feat - all feats are included! Note: everything will be reset if you reload the page!</p>
